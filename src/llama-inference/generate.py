...
def parse_args():
    ...
    parser.add_argument("--max-new-tokens", type=int, default=16384, help="Max new tokens to generate.")
    parser.add_argument("--temperature", type=float, default=0, help="Sampling temperature.")
    parser.add_argument("--top-p", type=float, default=1, help="Top-p nucleus sampling.")
    parser.add_argument("--top-k", type=int, default=-1, help="Top-k sampling (<=0 disables).")
